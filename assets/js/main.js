...
(function () {
  ...
  const DATA = {
    ...
    gunsan: {
      tag: '군산시 · ★ 거점', teams: 6, mentors: 2, assets: 11,
      desc: '호원대학교가 소재한 본 사업의 핵심 거점. 3개 학부(공연미디어·외식창업경영·호텔외식조리)의 동아리·리빙랩이 지역 자원을 활용한 창업 프로젝트를 운영.',
      news: [
        '공연미디어학부 "군산으로 어서오랑께" · 드론 미디어 콘텐츠',
        '외식창업경영학과 리빙랩 "호원맛ZIP 탐험대"',
        '호텔외식조리학과 동아리·리빙랩 "호원퀴진"',
        '㈜지방·㈜작정 MOU 체결 (2026.03.23)',
      ],
    },
    iksan: {
